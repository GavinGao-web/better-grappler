...
cd ~/better-grappler && cat > app/page.tsx << 'EOF'
'use client';
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="mt-10 bg-gray-900 border border-gray-800 rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-white font-bold">来自创始人 Gavin（加文）</h3>
              <p className="text-gray-500 text-xs">Better Grappler · 创始人</p>
            </div>
          </div>
          <p className="text-gray-300 text-sm leading-relaxed">
            各位柔友你们好，我是 Better Grappler AI训练产品的创始人Gavin，你们可以叫加文。由衷的感到高兴你们能愿意来玩 Better Grappler，也真心希望产品里的一些功能能够在一定程度上帮助你们成为更优秀的缠斗手！本人当前美本大二在读，在被学业持续拷打的同时也满怀憧憬的在世界各地穷游串馆训练。在高三结束的暑假第一次接触到了MMA，后来在大一开始正式训练摔跤和柔术。在刚入坑柔术的前一年半里我经历无数被军训或者降服，我相信这也是很多白带们的苦恼：缺乏对于柔术整个系统上的认知以及应该如何更切实有效的提升自己—— 于是我创建了 Better Grappler，希望能帮助到同样也在不断挨打的小伙伴们逐渐找到自己的"方法论"。你们可以在聊天框输入任何想问的问题（但最好是柔术哈），也可以填写自己的训练背景生成自己的"球星卡"，如果最近有比赛需求的柔友也可以用它来研究自己的打法以及分析潜在对手…… 相信在你们不断的反馈和帮助下，Better Grappler的功能会越来越多，也能帮助更多想要练习柔术的朋友！
          </p>
