      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="mt-10 bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            各位柔友你们好，我是 Better Grappler AI训练产品的创始人Gavin，你们也可以叫我加文。由衷的感到高兴你们能愿意来玩 Better Grappler，也真心希望产品里的一些功能能够在一定程度上帮助你们成为更优秀的缠斗手！本人当前美本大二在读，在被学业持续拷打的同时也满怀憧憬的在世界各地穷游串馆训练。在高三结束的暑假第一次接触到了MMA，后来在大一开始正式专注于柔术和摔跤。在刚入坑柔术的前一年半里我经历无数被军训或者降服，我相信这也是许多白带们的苦恼：初学者们缺乏对于柔术整体系统上的认知以及明确如何能够更切实有效的提升自己。特别是在水平层次不齐的训练馆里，只学习零散的动作或降服技术并不能很快的在实战中运用出来。于是乎我创建了 Better Grappler——希望能帮助到同样也在不断挨打的小伙伴们逐渐理解这项运动并寻找到自己的方法论。功能方面，你们可以在聊天框输入任何想问的问题（中英文皆可），也可以填写自己的训练背景生成自己的球星卡，如果最近有比赛需求的柔友也可以用它来研究自己的打法以及分析潜在对手。相信在你们不断的反馈和帮助下，Better Grappler的功能会越来越多，也能帮助更多想要练习柔术的朋友！
          </p>
